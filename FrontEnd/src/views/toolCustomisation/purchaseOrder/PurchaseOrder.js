import { cilPen, cilPlus, cilUser, cilX } from '@coreui/icons'
...
const PurchaseOrder = () => {
  ...
  const [rowsPerPage, setRowsPerPage] = useState(7) // Default rows per page
                          ...
                          <tr>
                            ...
                            {/* <td>
                              <CFormInput
                                ...
                                value={
                                  val.tasks.reduce((total, task) => {
                                    // Sum of subTasks hours for each task
                                    let subTasksHrsSum = task.subTasks.reduce((subTotal, subTask) => {
                                      let activitiesHrsSum = subTask.activities.reduce((activityTotal, activity) => {
                                        let activities_planned_Hrs = Number(activity.activities_planned_Hrs) || 0;
                          ...
                          <tr>
                            ...
                            {/* <td>
                              <CFormInput
                                ...
                                value={val.tasks[0].subTasks[0].activities[0].activities_planned_Hrs}
                            ...
                            {/* <td>
                              <CFormInput
                                ...
                                readOnly
                                value={
                                  val.tasks[0].subTasks[i].activities.reduce((total, activity) => {
                                    return total + (Number(activity.activities_planned_Hrs) || 0);
                                  }, 0)
                                }
                              />
                            ...
                            <tr>
                              ...
                              {/* <td>
                                  ...
                                  <CFormInput
                                    style={{ width: '50px' }}
                                    placeholder="Hrs"
                                    name={`task_planned_Hrs-${i+1}`}
                                    onChange={(e) => handleTaskInputChange(e, i, taskindex+1, 'task_planned_Hrs')}
                                    value={
                                      val.tasks[i].subTasks.reduce((subTotal, subTask) => {
                                        let activitiesHrsSum = subTask.activities.reduce((activityTotal, activity) => {
                                          let activities_planned_Hrs = Number(activity.activities_planned_Hrs) || 0;
                                          return activityTotal + activities_planned_Hrs;
                                        }, 0);
